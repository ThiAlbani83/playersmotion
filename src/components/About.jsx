      ...
      <div className="w-full bg-[url('/about.png')] bg-cover bg-no-repeat bg-center px-8 sm:px-16 md:px-28 lg:px-48 xl:px-80 py-5 md:py-10 lg:py-[60px] font-semibold flex flex-col gap-5 md:gap-7 lg:gap-10 xl:gap-14">
        ...
        <div className="flex flex-col w-full gap-5">
          <p className="text-[14px] leading-6 md:leading-8 lg:leading-10 tracking-wide md:text-base text-slate-100">
            ...
            unparalleled quality traffic to iGaming Operators worldwide. With a
            seasoned team boasting over 20 years of collective experience in the
            industry, we are dedicated to propelling your brand to new heights
          ...
          <p className="text-[14px] leading-6 md:leading-8 lg:leading-10 tracking-wide md:text-base text-slate-100">
            ...
            collaborations, and targeted Social Media Ads. Our expertise lies in
            crafting bespoke campaigns that not only attract but engage your
            target audience, ensuring maximum impact and conversion for your
            iGaming operations.
          </p>
          <p className="text-[14px] leading-6 md:leading-8 lg:leading-10 tracking-wide md:text-base text-slate-100">
            ...
            strategies to keep your brand at the forefront of the gaming market.
          </p>
          <p className="text-[14px] leading-6 md:leading-8 lg:leading-10 tracking-wide md:text-base text-slate-100">
            Whether you're looking to enhance brand visibility, increase player
            acquisition, or optimize your marketing ROI, Players Motion is your
            trusted partner. Join us on a journey where innovation meets
            experience, and together, let's redefine success in the iGaming
            industry.
          </p>
        </div>
      </div>
