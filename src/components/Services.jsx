...
const Services = () => {
  return (
    <div className="w-full bg-[#344054] px-8 sm:px-16 md:px-28 lg:px-48 xl:px-60 py-5 md:py-10 lg:py-[60px] font-semibold flex flex-col gap-5 md:gap-7 lg:gap-10 xl:gap-14">
